  ...
  10  if (create_new_file) then
     ...
     &                                  vname(4,indxAks)(1:lvar))
          call nf_add_attribute(ncid, hisAks, vname(:,indxAks),
     &                          5, NF_REAL, ierr)
        endif
     ...
     &                                  vname(4,indxHbbl)(1:lvar))
          call nf_add_attribute(ncid, hisHbbl, vname(:,indxHbbl), 5,
     &                          NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxSwflx)(1:lvar))
          call nf_add_attribute(ncid, hisSwflx, vname(:,indxSwflx), 5,
     &                          NF_REAL, ierr)
        endif
     ...
     &                               vname(3,indxShflx_rlw)(1:lvar))
          call nf_add_attribute(ncid, hisShflx_rlw,
     &         vname(:,indxShflx_rlw),5, NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxShflx_lat)(1:lvar))
          call nf_add_attribute(ncid, hisShflx_lat,
     &         vname(:,indxShflx_lat), 5, NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxShflx_sen)(1:lvar))
        call nf_add_attribute(ncid, hisShflx_sen,
     &       vname(:,indxShflx_sen), 5, NF_REAL, ierr)
      endif
        ierr=nf_enddef(ncid)
  ...
  10  if (create_new_file) then
     ...
     &                                  vname(4,indxAks)(1:lvar))
          call nf_add_attribute(ncid, avgAks, vname(:,indxAks),
     &                          5, NF_REAL, ierr)
        endif
     ...
     &                                  vname(4,indxHbbl)(1:lvar))
          call nf_add_attribute(ncid, avgHbbl, vname(:,indxHbbl), 5,
     &                          NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxSwflx)(1:lvar))
          call nf_add_attribute(ncid, avgSwflx, vname(:,indxSwflx), 5,
     &                          NF_REAL, ierr)
        endif
     ...
     &                               vname(3,indxShflx_rlw)(1:lvar))
          call nf_add_attribute(ncid, avgShflx_rlw,
     &         vname(:,indxShflx_rlw),5, NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxShflx_lat)(1:lvar))
          call nf_add_attribute(ncid, avgShflx_lat,
     &         vname(:,indxShflx_lat), 5, NF_REAL, ierr)
        endif
     ...
     &                                 vname(3,indxShflx_sen)(1:lvar))
        call nf_add_attribute(ncid, avgShflx_sen,
     &       vname(:,indxShflx_sen), 5, NF_REAL, ierr)
      endif
        ierr=nf_enddef(ncid)
         write(stdout,'(6x,4A,1x,A,i4)')

     ...
     &                                     ,A3d(1,3,trd))
      ...
      subroutine omega_tile (Istr,Iend,Jstr,Jend, CF, DC,FC
     &                    ,romega)
      implicit none
     ...
     &          , isalt
      ...
      real CF  (Istr-2:Iend+2,Jstr-2:Jend+2    )
      real romega(Istr-2:Iend+2,Jstr-2:Jend+2,N  )
...
!$acc kernels if(compute_on_device) default(present)
       do j=Jstr,Jend
        ...
        do k=1,N,+1
          do i=Istr,Iend
            FC(i,k)=FC(i,k-1) -Huon(i+1,j,k)+Huon(i,j,k)

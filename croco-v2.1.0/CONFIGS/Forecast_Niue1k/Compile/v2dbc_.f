...
!$acc kernels if(compute_on_device) default(present) async(1)
     ...
     &                                     )/(cff+cx)
          vbar(i,Jstr,knew)=(1.D0-tau)*vbar(i,Jstr,knew)
     &                           +tau*vbarbry_south(i)
     ...
     &                                       )/(cff+cx)
          vbar(i,Jend+1,knew)=(1.D0-tau)*vbar(i,Jend+1,knew)
     &                               +tau*vbarbry_north(i)
     ...
     &                                       )/(cff+cx)
          vbar(Istr-1,j,knew)=(1.D0-tau)*vbar(Istr-1,j,knew)
     &                                +tau*vbarbry_west(j)
     ...
     &                                       )/(cff+cx)
          vbar(Iend+1,j,knew)=(1.D0-tau)*vbar(Iend+1,j,knew)
     &                                +tau*vbarbry_east(j)

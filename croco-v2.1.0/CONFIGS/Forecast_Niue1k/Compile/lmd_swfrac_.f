     ...
     &           jul_off=2440000.D0)
      ...
      integer*4 Jwtype(0:Lm+1+padd_X,0:Mm+1+padd_E)
     ...
     &  lmd_mu1=(/0.35D0,0.6D0,1.0D0,1.5D0,1.4D0/)
      real,parameter,dimension(5)::
     &  lmd_mu2=(/23.D0,20.D0,17.D0,14.D0,7.9D0/)
      real,parameter,dimension(5)::
     &  lmd_r1=(/0.58D0,0.62D0,0.67D0,0.77D0,0.78D0/)
      lmd_Jwt=1

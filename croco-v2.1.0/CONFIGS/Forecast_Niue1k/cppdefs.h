...
# undef ANA_SRFLUX    /* analytical surface shortwave radiation*/


# define BULK_FLUX
# ifdef BULK_FLUX /*Default is COARE3 Parametrization or chose one of the following 3 */
#  undef  BULK_ECUMEV0
#  undef  BULK_ECUMEV6
#  undef  BULK_WASP
...
#   define  ERA_ECMWF
#  endif
#  undef READ_PATM /*read atm pressure and use gradint in eqs */
#  ifdef READ_PATM
#   define OBC_PATM
#  endif
#  undef  ABL1D

...
# Dates
Ystart, Mstart = '2025', '09'   # Starting month
Yend, Mend  = '2025','09'       # Ending month 
Yorig, Morig, Dorig = '2005', '01', '01' # origin of time as: days since Yorig-Morig-Dorig

# Input data information and formating
inputdata = 'f_mercator'    # Input data dictionnary as defined in the Readers/ibc_reader.py
input_dir = '/DATA/CROCO/croco-v2.1.0/CONFIGS/Forecast_Niue4/DATA/Forecast/'
...
croco_dir = '/DATA/CROCO/croco-v2.1.0/CONFIGS/Forecast_Niue4/CROCO_FILES/' 
croco_grd = 'croco_grd.nc'
sigma_params = dict(theta_s=7, theta_b=2, N=50, hc=200) # Vertical streching, sig_surf/sig_bot/ nb level/critical depth
...
if __name__ == '__main__':
    ...
    dtenddt = plt.datetime.datetime(int(Yend),int(Mend),1,12) \
            + relativedelta(months=0,days=3) # Last day of the ending month

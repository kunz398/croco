...
# Dates
# starting date
Yini, Mini, Dini, Hini  = '2025', '08', '30', '12' # Month and days need to be 2-digits format
# reference time (default = ini time)
Yorig, Morig, Dorig = '2005', '01', '01' # Month and days need to be 2-digits format
...
input_file  = f'{input_dir}{input_prefix}7548.cdf'

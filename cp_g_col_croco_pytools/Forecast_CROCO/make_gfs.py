...
do_blk = bool(makeblk_gfs)
do_frc = bool(makefrc_gfs)

if (not do_blk) and (not do_frc):
  print('Both makeblk_gfs and makefrc_gfs are 0: no GFS atmospheric files requested. Exiting make_gfs.py.')
  raise SystemExit(0)
#
################################################################
